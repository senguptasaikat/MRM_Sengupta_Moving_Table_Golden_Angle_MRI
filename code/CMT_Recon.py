...
# Golden Angle Phantom
recon_list.append( { 'base_name' : 'Phantom_GA', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' :  int(92), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_GA', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(148), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_GA', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(185), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_GA', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(256), 'npe_per_180' :  int(256) } )

# Linear Angle Phantom : 92 projections over 180 degrees
recon_list.append( { 'base_name' : 'Phantom_LA_92p', 'TR': 2.7088e-3, 'rad_percentage' : 36.00, 'GA_Flag': False, 'npes_per_slice' :  int(92), 'npe_per_180' :  int(92) } )
recon_list.append( { 'base_name' : 'Phantom_LA_92p', 'TR': 2.7088e-3, 'rad_percentage' : 36.00, 'GA_Flag': False, 'npes_per_slice' : int(148), 'npe_per_180' :  int(92) } )
recon_list.append( { 'base_name' : 'Phantom_LA_92p', 'TR': 2.7088e-3, 'rad_percentage' : 36.00, 'GA_Flag': False, 'npes_per_slice' : int(185), 'npe_per_180' :  int(92) } )
recon_list.append( { 'base_name' : 'Phantom_LA_92p', 'TR': 2.7088e-3, 'rad_percentage' : 36.00, 'GA_Flag': False, 'npes_per_slice' : int(256), 'npe_per_180' :  int(92) } )

# Linear Angle Phantom : 148 projections over 180 degrees
recon_list.append( { 'base_name' : 'Phantom_LA_148p', 'TR': 2.7088e-3, 'rad_percentage' : 57.80, 'GA_Flag': False, 'npes_per_slice' :  int(92), 'npe_per_180' :  int(148) } )
recon_list.append( { 'base_name' : 'Phantom_LA_148p', 'TR': 2.7088e-3, 'rad_percentage' : 57.80, 'GA_Flag': False, 'npes_per_slice' : int(148), 'npe_per_180' :  int(148) } )
recon_list.append( { 'base_name' : 'Phantom_LA_148p', 'TR': 2.7088e-3, 'rad_percentage' : 57.80, 'GA_Flag': False, 'npes_per_slice' : int(185), 'npe_per_180' :  int(148) } )
recon_list.append( { 'base_name' : 'Phantom_LA_148p', 'TR': 2.7088e-3, 'rad_percentage' : 57.80, 'GA_Flag': False, 'npes_per_slice' : int(256), 'npe_per_180' :  int(148) } )

# Linear Angle Phantom : 185 projections over 180 degrees
recon_list.append( { 'base_name' : 'Phantom_LA_185p', 'TR': 2.7088e-3, 'rad_percentage' : 72.30, 'GA_Flag': False, 'npes_per_slice' :  int(92), 'npe_per_180' :  int(185) } )
recon_list.append( { 'base_name' : 'Phantom_LA_185p', 'TR': 2.7088e-3, 'rad_percentage' : 72.30, 'GA_Flag': False, 'npes_per_slice' : int(148), 'npe_per_180' :  int(185) } )
recon_list.append( { 'base_name' : 'Phantom_LA_185p', 'TR': 2.7088e-3, 'rad_percentage' : 72.30, 'GA_Flag': False, 'npes_per_slice' : int(185), 'npe_per_180' :  int(185) } )
recon_list.append( { 'base_name' : 'Phantom_LA_185p', 'TR': 2.7088e-3, 'rad_percentage' : 72.30, 'GA_Flag': False, 'npes_per_slice' : int(256), 'npe_per_180' :  int(185) } )

# Linear Angle Phantom : 256 projections over 180 degrees
recon_list.append( { 'base_name' : 'Phantom_LA_256p', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': False, 'npes_per_slice' :  int(92), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_LA_256p', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': False, 'npes_per_slice' : int(148), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_LA_256p', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': False, 'npes_per_slice' : int(185), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Phantom_LA_256p', 'TR': 2.7088e-3, 'rad_percentage' : 100.00, 'GA_Flag': False, 'npes_per_slice' : int(256), 'npe_per_180' :  int(256) } )

# Golden Angle Human 
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' :  int(68), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' :  int(81), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(122), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(162), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(203), 'npe_per_180' :  int(256) } )
recon_list.append( { 'base_name' : 'Human_GA', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': True, 'npes_per_slice' : int(256), 'npe_per_180' :  int(256) } )

# Linear Angle Human
recon_list.append( { 'base_name' :  'Human_LA_68p', 'TR': 3.7e-3, 'rad_percentage' :  26.39, 'GA_Flag': False, 'npes_per_slice' :  int(68), 'npe_per_180' :  int(68) } )
recon_list.append( { 'base_name' :  'Human_LA_81p', 'TR': 3.7e-3, 'rad_percentage' :  31.67, 'GA_Flag': False, 'npes_per_slice' :  int(81), 'npe_per_180' :  int(81) } )
recon_list.append( { 'base_name' : 'Human_LA_122p', 'TR': 3.7e-3, 'rad_percentage' :  47.50, 'GA_Flag': False, 'npes_per_slice' : int(122), 'npe_per_180' :  int(122) } )
recon_list.append( { 'base_name' : 'Human_LA_162p', 'TR': 3.7e-3, 'rad_percentage' :  63.36, 'GA_Flag': False, 'npes_per_slice' : int(162), 'npe_per_180' :  int(162) } )
recon_list.append( { 'base_name' : 'Human_LA_203p', 'TR': 3.7e-3, 'rad_percentage' :  79.20, 'GA_Flag': False, 'npes_per_slice' : int(203), 'npe_per_180' :  int(203) } )
recon_list.append( { 'base_name' : 'Human_LA_256p', 'TR': 3.7e-3, 'rad_percentage' : 100.00, 'GA_Flag': False, 'npes_per_slice' : int(256), 'npe_per_180' :  int(256) } )
...
for recon in recon_list:
    ...
    # NUMBER OF PROFILES TO USE PER SLICE
    # For Phantom: 256, 185, 148 or 92
    # For Human: 256, 203, 162, 122, 81 or 68
    npes_per_slice = recon['npes_per_slice']  
                	 
    # path to input data file              
    data_file = pathstr_python_script + '/data_input/' + base_name + '.mat'

    # EXAM CARD PARAMETERS
    TR = recon['TR']
    vtable = 20.0   # mm/s
    voxel_size_x_mm = 1.5625
    ...
    nslices = int(1140)  # number of slices in z direction
    ...
    zero_dc_phase = True            	# zero the DC phase after k-space shift correction?
    ...
    im_file = pathstr_python_script + '/data_output/' + base_name + '_' + str(npes_per_slice) + '.mat'
